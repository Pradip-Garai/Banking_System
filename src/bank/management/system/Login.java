...
public class Login extends JFrame implements ActionListener{
    ...
    public Login() {
        ...
        // set image 
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/logo.jpg")); // load from system
        ...
        setLocation(350,200); // set Frame location in window
         ...
         try {
            ...
            c = DriverManager.getConnection("jdbc:mysql://localhost:3306/bank", "root", "PRADIPSQL12");
